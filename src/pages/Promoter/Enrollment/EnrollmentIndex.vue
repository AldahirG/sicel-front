...
const goToEdit = (id) => {
  router.push({ name: 'promoter/editEnrollment', params: { id } });
};

const goToShow = (id) => {
  router.push({ name: 'promoter/showEnrollment', params: { id } });
};
    ...
    <Table>
      <template #header>
        <TableRow>
          ...
          <TableHeaderCell>Promoción de inscripción</TableHeaderCell>
