    ...
    data() {
        return {
            ...
            bread: [
                ...
                { label: "Editar", name: "editLeadPromotor" }
            ]
        };
    },
    methods: {
        ...
        async update() {
            ...
            try {
                ...
                this.$router.push("/promoter/leads");
            } catch (error) {
        ...
        <BigFormContainer>
            <form @submit.prevent="update">
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <router-link :to="{ path: `/promoter/comments/lead/${this.$route.params.id}` } "
                        class="inline-block px-4 py-2 text-white font-semibold bg-sky-700 hover:bg-sky-800 rounded-md duration-200">
                        Comentarios
                    </router-link>

                    <button type="submit"
                        class="inline-block py-2 px-4 text-white bg-green-500 hover:bg-green-600 rounded-md duration-200">
                        Guardar
                    </button>
                </div>
